...
namespace MyGame
{
    public unsafe class FreeTypeClassApi
    {
        ...
        /// <summary>
        /// Initialize a FreeTypeClassApi instance with a pointer to the Face instance.
        /// </summary>
        public FreeTypeClassApi(string filepathname)
        {
        ...
        /// <summary>
        /// Initialize a FreeTypeClassApi instance with font data.
        /// </summary>
        public FreeTypeClassApi(FreeTypeLibrary library, IntPtr fontData, int dataLength, int faceIndex = 0)
        {
            _Library = library;
        ...
        public void DoneFreetype()
        {
            ...
            FT.FT_Done_FreeType(_Library.Native);
        }
        #endregion
    }
}